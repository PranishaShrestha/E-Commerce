          ...
          <div className="row">
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="blog__item">
                ...
                <div className="blog__item__text">
                  <span>
                    <img src="img/icon/calendar.pn/g" alt="" /> 16 February 2020
                  </span>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="blog__item">
                ...
                <div className="blog__item__text">
                  <span>
                    <img src="img/icon/calendar.pn/g" alt="" /> 21 February 2020
                  </span>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="blog__item">
                ...
                <div className="blog__item__text">
                  <span>
                    <img src="img/icon/calendar.pn/g" alt="" /> 28 February 2020
                  </span>
